...
## General
 ...
 - [Scratch](https://scratch.mit.edu/): Plataforma gratuïta desenvolupada pel MIT per a que infants i joves puguin aprendre a programar mitjançant un entorn visual i interactiu.
 - [Tynker](https://www.tynker.com/): Plataforma educativa que ofereix cursos de programació per a nens, amb una varietat de jocs i activitats interactives.
 - [Kodable](https://www.kodable.com/): Aplicació educativa dissenyada per ensenyar als nens els conceptes bàsics de la programació mitjançant jocs divertits.
 - [Lightbot](https://lightbot.com/): Joc de trencaclosques que introdueix els conceptes bàsics de la programació a través de la resolució de problemes.
